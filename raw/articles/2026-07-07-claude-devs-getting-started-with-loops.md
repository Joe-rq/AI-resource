...
> **Author**: @delba_oliveira (published via @ClaudeDevs, Verified account)
> **Title**: Getting started with loops
> **Published**: 2026-07-07 (≈12h before capture)
> **Captured**: 2026-07-07 via kimi-webbridge
> **Engagement**: 203 replies · 1.4K reposts · 10K likes · 23.6K bookmarks · 2.4M views

![cover](./2026-07-07-claude-devs-getting-started-with-loops/cover.jpg)
...
![fig1-turn-based](./2026-07-07-claude-devs-getting-started-with-loops/fig1-turn-based.jpg)
...
![fig2-goal-based](./2026-07-07-claude-devs-getting-started-with-loops/fig2-goal-based.jpg)
...
![fig3-proactive](./2026-07-07-claude-devs-getting-started-with-loops/fig3-proactive.jpg)
