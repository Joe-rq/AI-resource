...
created: 2026-05-19
updated: 2026-05-19
sources: ["02-minimax-agent-team-tech-report", "04-anthropic-multi-agent-research-system", "05-anthropic-managed-agents-api", "06-claude-code-agent-teams", "07-anthropic-cookbook-coordinate-specialist-team"]
...
| 模式 | 验证方式 | 调度方式 | 代表 |
|------|----------|----------|------|
| Orchestrator/Specialist | Lead 判断 | 中央协调 | Anthropic、Claude Code Teams |
| Worker/Verifier | 直接对抗 | 状态机 | MiniMax Mavis |
| Handoff (接力式) | 无回头 | 链式传递 | OpenAI Agents SDK |
